 ...
 * This file demonstrates how to integrate Sagepulse with a web frontend
 */

// For React/Vue/Angular applications
export class SagepulseClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SagepulseClient(provider, contractAddress);
